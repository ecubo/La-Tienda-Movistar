...
- (void)createViews
{
    ...
    self.toolbar.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
    ...
    //    self.addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(labelInset, 40, self.view.bounds.size.width - labelInset, LOCATIONBAR_HEIGHT)];
    ...
    [self.forwardButton setTintColor:[UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1]];

    NSString* backArrowString = NSLocalizedString(@"◄", nil); // create arrow from Unicode char
    self.backButton = [[UIBarButtonItem alloc] initWithTitle:backArrowString style:UIBarButtonItemStylePlain target:self action:@selector(goBack:)];
    self.backButton.enabled = YES;
    self.backButton.imageInsets = UIEdgeInsetsZero;
    [self.backButton setTintColor:[UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1]];
...
- (void)setCloseButtonTitle:(NSString*)title
{
    ...
    [self.closeButton setTintColor:[UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1]];
