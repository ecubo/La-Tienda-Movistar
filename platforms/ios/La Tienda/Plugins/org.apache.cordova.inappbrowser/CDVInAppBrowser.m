...
- (void)createViews
{
    ...
    self.toolbar.backgroundColor = [UIColor colorWithRed:255.0 / 255.0 green:255.0 / 255.0 blue:255.0 / 255.0 alpha:1];

    //CGFloat labelInset = 5.0;
    //float locationBarY = toolbarIsAtBottom ? self.view.bounds.size.height - FOOTER_HEIGHT : self.view.bounds.size.height - LOCATIONBAR_HEIGHT;

    //self.addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(labelInset, locationBarY, self.view.bounds.size.width - labelInset, LOCATIONBAR_HEIGHT)];
    self.addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 31, self.view.bounds.size.width - 100, LOCATIONBAR_HEIGHT)];
    ...
    self.addressLabel.textColor = [UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1];
//    self.addressLabel.textColor = [UIColor colorWithRed:255.0 / 255.0 green:255.0 / 255.0 blue:255.0 / 255.0 alpha:1];
    ...
    self.forwardButton.tintColor = [UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1];

    NSString* backArrowString = NSLocalizedString(@"◄", nil); // create arrow from Unicode char
    self.backButton = [[UIBarButtonItem alloc] initWithTitle:backArrowString style:UIBarButtonItemStylePlain target:self action:@selector(goBack:)];
    self.backButton.enabled = YES;
    self.backButton.imageInsets = UIEdgeInsetsZero;
    self.backButton.tintColor = [UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1];
...
//    self.view.backgroundColor = [UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1];
...
- (void)setCloseButtonTitle:(NSString*)title
{
    ...
    self.closeButton.enabled = YES;
    self.closeButton.tintColor = [UIColor colorWithRed:0.0 / 255.0 green:92.0 / 255.0 blue:132.0 / 255.0 alpha:1];
...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    self.addressLabel.text = [NSString stringWithFormat:@"%@", theTitle];
...
- (void)webView:(UIWebView*)theWebView didFailLoadWithError:(NSError*)error
{
    ...
    self.addressLabel.text = NSLocalizedString(@"Error de carga", nil);
